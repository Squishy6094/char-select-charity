Lights1 cherry_metal_cap_Metal__CAP__lights = gdSPDefLights1(
	0xBC, 0xBC, 0xBC,
	0x0, 0x0, 0x0, 0x28, 0x28, 0x28);

Texture cherry_metal_cap_Metal_Shade_rgba16_rgba16[] = {
	#include "actors/cherry_metal_cap/Metal_Shade.rgba16.inc.c"
};

Texture cherry_metal_cap_Metal_Light_rgba16_rgba16[] = {
	#include "actors/cherry_metal_cap/Metal_Light.rgba16.inc.c"
};

Vtx cherry_metal_cap_Metal_Cap_DL_mesh_layer_1_vtx_0[87] = {
	...
	{{{0, 61, 135}, 0, {1283, -380}, {0x00, 0x50, 0x63, 0xFF}}},
	...
	{{{-60, 103, -97}, 0, {-260, 495}, {0xAB, 0x42, 0xBD, 0xFF}}},
	{{{0, 144, -79}, 0, {-260, 495}, {0x00, 0x7D, 0xEB, 0xFF}}},
	{{{-65, 91, -17}, 0, {-260, 495}, {0xB9, 0x69, 0xFF, 0xFF}}},
	...
	{{{64, 91, -17}, 0, {-260, 495}, {0x47, 0x69, 0xFF, 0xFF}}},
	{{{91, 80, -50}, 0, {-260, 495}, {0x71, 0x36, 0xEC, 0xFF}}},
	{{{79, 5, -55}, 0, {-260, 495}, {0x49, 0x9E, 0xDC, 0xFF}}},
	{{{67, 45, -91}, 0, {-260, 495}, {0x57, 0xE4, 0xA8, 0xFF}}},
	{{{0, 10, -110}, 0, {-260, 495}, {0x00, 0xB4, 0x9A, 0xFF}}},
	{{{0, -16, -72}, 0, {-260, 495}, {0x00, 0x81, 0x07, 0xFF}}},
	{{{-79, 5, -55}, 0, {-260, 495}, {0xB7, 0x9E, 0xDC, 0xFF}}},
	{{{-68, 45, -91}, 0, {-260, 495}, {0xA9, 0xE4, 0xA8, 0xFF}}},
	{{{0, 90, -139}, 0, {-260, 495}, {0x00, 0x1B, 0x84, 0xFF}}},
	{{{-60, 103, -97}, 0, {-260, 495}, {0xAB, 0x42, 0xBD, 0xFF}}},
	{{{0, 144, -79}, 0, {-260, 495}, {0x00, 0x7D, 0xEB, 0xFF}}},
	{{{60, 103, -97}, 0, {-260, 495}, {0x55, 0x42, 0xBD, 0xFF}}},
	{{{0, 125, -17}, 0, {-260, 495}, {0x00, 0x79, 0x26, 0xFF}}},
	{{{-65, 91, -17}, 0, {-260, 495}, {0xB9, 0x69, 0xFF, 0xFF}}},
	{{{0, 125, -17}, 0, {-260, 495}, {0x00, 0x78, 0xD8, 0xFF}}},
	{{{0, 143, 36}, 0, {-260, 495}, {0x00, 0x7F, 0x03, 0xFF}}},
	{{{-71, 108, 50}, 0, {-260, 495}, {0xAE, 0x5C, 0x1F, 0xFF}}},
};

Gfx cherry_metal_cap_Metal_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(cherry_metal_cap_Metal_Cap_DL_mesh_layer_1_vtx_0 + 0, 64, 0),
	...
	gsSPVertex(cherry_metal_cap_Metal_Cap_DL_mesh_layer_1_vtx_0 + 64, 23, 0),
...
Gfx mat_cherry_metal_cap_Metal__CAP_[] = {
	gsSPSetGeometryMode(G_TEXTURE_GEN),
	gsSPLight(&cherry_metal_cap_Metal__CAP__lights.l, 1),
    gsSPLight(&cherry_metal_cap_Metal__CAP__lights.a, 2),
	...
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, cherry_metal_cap_Metal_Shade_rgba16_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, cherry_metal_cap_Metal_Light_rgba16_rgba16),
...
Gfx mat_revert_cherry_metal_cap_Metal__CAP_[] = {
...
Gfx cherry_metal_cap_Metal_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_cherry_metal_cap_Metal__CAP_),
	gsSPDisplayList(cherry_metal_cap_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_cherry_metal_cap_Metal__CAP_),
	gsSPEndDisplayList(),
};

Gfx cherry_metal_cap_material_revert_render_settings[] = {
	gsDPPipeSync(),
